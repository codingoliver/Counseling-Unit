...
<head>
    ...
    <link href="<?php echo base_url('asset/stud/plugins/chartist-plugin-tooltip-master/dist/chartist-plugin-tooltip.css') ?>"
          rel="stylesheet">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark" href=""
                           data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img
                                    src="<?php echo base_url($data[0]->image) ?>" alt="" class="profile-pic m-r-10"/>
                        ...
                        <ul class="dropdown-menu pull-right">
                            ...
                            <li><a href="<?php echo base_url('index.php/Welcome/sign_out') ?>"><i
                                            class="mdi mdi-close-circle-outline"></i>Sign Out</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
            ...
            <nav class="sidebar-nav">
                <ul id="sidebarnav">
                    <li><a class="waves-effect waves-dark"
                           href="<?php echo base_url('index.php/Welcome/counselor_dashboard') ?>" aria-expanded="false"><i
                                    class="mdi mdi-gauge"></i><span class="hide-menu">Dashboard</span></a>
                    </li>
                    <li><a class="waves-effect waves-dark"
                           href="<?php echo base_url('index.php/Welcome/counselor_appointments') ?>"
                           aria-expanded="false"><i class="mdi mdi-alarm-multiple"></i><span class="hide-menu">Appointments</span></a>
                    </li>
                    <li><a class="waves-effect waves-dark"
                           href="<?php echo base_url('index.php/Welcome/counselor_student') ?>" aria-expanded="false"><i
                                    class="mdi mdi-account-multiple"></i><span
                                    class="hide-menu">View Student Records</span></a>
                    </li>
                    <li><a class="waves-effect waves-dark"
                           href="<?php echo base_url('index.php/Welcome/anonymous_messages') ?>"
                           aria-expanded="false"><i class="mdi mdi-message-bulleted-off"></i><span class="hide-menu">Anonymous Messages</span></a>
                    </li>
                    <li><a class="waves-effect waves-dark"
                           href="<?php echo base_url('index.php/Welcome/chatroom_counselor') ?>"
                           aria-expanded="false"><i class="mdi mdi-wechat"></i><span class="hide-menu">Chat</span></a>
                    </li>

                    <li><a class="waves-effect waves-dark"
                           href="<?php echo base_url('index.php/Welcome/counselor_profile') ?>" aria-expanded="false"><i
                                    class="mdi mdi-account"></i><span class="hide-menu">Profile</span></a>
                    </li>
                                            ...
                                            echo "
                                                 <tr>   
                                                    ...
                                                    data-date=\"$val->date\" data-time=\"$val->time\" data-student=\"$name\">
                                                        Reschedule</button>
                                                    <button class='btn btn-danger' style='margin-right: 5px' data-a_id=\"$val->a_id\" data-status =\"$val->status\" value='canceled'
                                                    data-date=\"$val->date\" data-time=\"$val->time\" data-student=\"$name\">
                                                        Cancel</button>
                                                          <button class='btn btn-info' style='margin-right: 5px' 
                                                          data-a_id=\"$val->a_id\" data-status =\"$val->status\" value='honored'
                                                          data-date=\"$val->date\" data-time=\"$val->time\" data-student=\"$name\">
                                                        Honored</button>
                                                    </td>
                                                </tr>    
    ...
    <script>
                ...
                function (data, status) {
                    ...
                    if (status === 'success') {
                        if ($st === 'rescheduled') {
                            ...
                            swal("Success!", "Appointment honored successfully", "success");
                        } else {
                            swal("Success!", "Appointment accepted successfully", "success");
                        }
                        window.location = "http://localhost/counseling/index.php/Welcome/counselor_appointment_item_accepted";
                    } else {
        ...
        $('button').on('click', function () {
            ...
            if ($status === 'accepted') {
                ...
                $msg = 'mark as honored';
                $trail = 'has attended the appointment with ' + student + ' for ' + datetime;
            } else {
                $msg = 'reschedule';
