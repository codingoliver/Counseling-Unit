        ...
        <div class="container-fluid">
            ...
            <div class="row page-titles">
                <div class="col-md-5 col-8 align-self-center">
                    <h4 class="text-themecolor">Honored Appointments</h4>
                    <h5 style="color: grey">These are the appointments that you have honored or attended to</h5>
                </div>
            </div>
    ...
    <script>
        ...
        $('button').on('click', function () {
            ...
            if( ($status === 'rescheduled') ) {
               ...
               // alert($('#divAppointmentID').data('a_id'));
                return;
            }
        ...
        function  reschedule() {
            ...
            $.post('http://localhost/counseling/index.php/Welcome/reschedule_appointment',
                ...
                function (data, status) {
                   // alert('finished rescheduled');
                    clicked(a_id, 'rescheduled');
                }
            );
