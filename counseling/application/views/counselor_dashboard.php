                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <li  class="nav-item dropdown">
                            <a href="javascript:void(0);" class="nav-link dropdown-toggle text-muted waves-effect waves-dark" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <button type="button" class="btn btn-info">
                                    Appointments<span class="glyphicon glyphicon-comment"></span>
                                    <span class="badge badge-notify"><?php echo $waiting_appointments_total_number; ?></span>
                                </button>
                            </a>
                            <ul class="dropdown-menu">
                                <li class="body">
                                    <ul class="menu">
                                        <?php
                                            foreach ($waiting_appointments as $waiting_appointment) {

                                                $fullname = $waiting_appointment->firstname.'_'.$waiting_appointment->lastname;
                                                $datetime = $waiting_appointment->date.'_'.$waiting_appointment->time;

                                                $filter_string = $fullname.'_'.$datetime;
                                                $url = base_url('index.php/Welcome/counselor_appointment_item/'.$filter_string);
                                                $fullname = $waiting_appointment->firstname.' '.$waiting_appointment->lastname;
                                                $datetime = $waiting_appointment->date.' '.$waiting_appointment->time;
                                                echo "
                                                      <li>
                                                        <a href=\"$url\">
                                                            <div class=\"menu-info\">
                                        ...
                                        <li>
                                            <a href="javascript:void(0);">
                                                <div class="icon-circle bg-light-green">
                                                    <i class="material-icons">John Doe</i>
                                                </div>
                                                <div class="menu-info">
                                                    <h4>requested an appointment</h4>
                                                    <p>
                                                        <i class="material-icons"></i> 14 mins ago
                                                    </p>
                                                </div>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="javascript:void(0);">
                                                ...
                                                <div class="menu-info">
                                                    <h4>requested an appointment</h4>
                                                    <p>
                                                        <i class="material-icons"></i> 25 mins ago
                                                    </p>
                                                </div>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="javascript:void(0);">
                                                ...
                                                <div class="menu-info">
                                                    <h4>requested an appointment</h4>
                                                    <p>
                                                        <i class="material-icons"></i> 33 mins ago
                                                    </p>
                                                </div>
                                            </a>
                                        </li>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-xlg-3 col-md-5">
                        <div class="card">
                            <div class="card-block">
                                <center class="m-t-30">  <a href="<?php echo base_url('index.php/Welcome/counselor_appointments')?>">
                                        <img src="<?php echo base_url('asset/images/appointment.png') ?>" class="img-circle" width="150" /></a>
                                    <a href="<?php echo base_url('index.php/Welcome/counselor_appointments')?>"><h4 class="card-title m-t-10">Appointments</h4></a>
                    ...
                    <div class="col-lg-4 col-xlg-3 col-md-5">
                        <div class="card">
                            <div class="card-block">
                                <center class="m-t-30"> <a href="<?php echo base_url('index.php/Welcome/counselor_student')?>">
                                        <img src="<?php echo base_url('asset/images/student.png') ?>" class="img-circle" width="150" /></a>
                                    <a href="<?php echo base_url('index.php/Welcome/counselor_student')?>"><h4 class="card-title m-t-10">Students</h4></a>
                                    <h6 class="card-subtitle">view students records</h6>
                                    <div class="row text-center justify-content-md-center">
                                    </div>
                                </center>
                            </div>
                    ...
                    <div class="col-lg-4 col-xlg-3 col-md-5">
                        <div class="card">
                            <div class="card-block">
                                <center class="m-t-30">
                                    <a href="<?php echo base_url('index.php/Welcome/chatroom_counselor')?>">
                                        <img src="<?php echo base_url('asset/images/chat.png') ?>" class="img-circle" width="150" />
                                    </a>
                                    <a href="<?php echo base_url('index.php/Welcome/chatroom_counselor')?>"> <h4 class="card-title m-t-10">Chat</h4></a>
                                    <h6 class="card-subtitle">chat with students</h6>
                                    <div class="row text-center justify-content-md-center">
                                    </div>
                                </center>
                            </div>
                    ...
                    <div class="col-lg-4 col-xlg-3 col-md-5">
                        <div class="card">
                            <div class="card-block">
                                <center class="m-t-30">
                                    <a href="<?php echo base_url('index.php/Welcome/anonymous_messages')?>">
                                    <img src="<?php echo base_url('asset/images/message.png') ?>" class="img-circle" width="150" />
                                    </a>
                                    <a href="<?php echo base_url('index.php/Welcome/anonymous_messages')?>">
                                        <h4 class="card-title m-t-10">Anonymous Messages</h4>
                                    </a>
                                    <h6 class="card-subtitle">check out these messages</h6>
                                    <div class="row text-center justify-content-md-center">
                                    </div>
                                </center>
                            </div>
                    ...
                    <div class="col-lg-4 col-xlg-3 col-md-5">
                        <div class="card">
                            <div class="card-block">
                                <center class="m-t-30">
                                    <a href="<?php echo base_url('index.php/Welcome/counselor_specialty')?>">
                                        <img src="<?php echo base_url('asset/images/category.png') ?>" class="img-circle" width="150" />
                                    </a>
                                    <a href="<?php echo base_url('index.php/Welcome/counselor_specialty')?>">
                                        <h4 class="card-title m-t-10">Specialty</h4>
                                    </a>
                                    <h6 class="card-subtitle">edit your counseling specialty</h6>
                                    <div class="row text-center justify-content-md-center">
                                    </div>
                                </center>
                            </div>
                    ...
                    <div class="col-lg-4 col-xlg-3 col-md-5">
                        <div class="card">
                            <div class="card-block">
                                <center class="m-t-30">
                                    <a href="<?php echo base_url('index.php/Welcome/counselor_profile')?>">
