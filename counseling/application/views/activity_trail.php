                ...
                <!-- ============================================================== -->
                 <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor">Activity Trail</h3>
                        
                         <a href="<?php echo base_url('index.php/Welcome/activity_graph') ?>" class=" waves-effect waves-dark btn btn-primary btn-md btn-success"
                            >CHECK OUT VISUAL REPORT</a>
                                ...
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <?php
                                        foreach ($data2 as $val) {
                                            ...
                                            $url = base_url($val->image);
                                            $name = $val->firstname . ' ' . $val->lastname;
                                            $trail = $val->trail;
                                            echo "
                                                <tr>
                                                <td><img src='$url' width='60' height='60'></td>
                                                <td>$name</td>
                                                <td>$trail</td>
                                                </tr>
                                            ";
