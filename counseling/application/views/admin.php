            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor">Admin Portal</h3>
                        <ol class="breadcrumb">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-xlg-3 col-md-5">
                        <div class="card">
                            <div class="card-block">
                                <center class="m-t-30">  <a href="<?php echo base_url('index.php/Welcome/counselor')?>">
                                        <img src="<?php echo base_url('asset/images/supervisor.png') ?>" class="img-circle" width="150" /></a>
                                    <a href="<?php echo base_url('index.php/Welcome/counselor')?>"><h4 class="card-title m-t-10">Counselors</h4></a>
                                    <h6 class="card-subtitle">manage your counselors here</h6>
                    ...
                    <div class="col-lg-4 col-xlg-3 col-md-5">
                        <div class="card">
                            <div class="card-block">
                                <center class="m-t-30"> <a href="<?php echo base_url('index.php/Welcome/admin_student')?>">
                                        <img src="<?php echo base_url('asset/images/student.png') ?>" class="img-circle" width="150" /></a>
                                    <a href="<?php echo base_url('index.php/Welcome/admin_student')?>"><h4 class="card-title m-t-10">Students</h4></a>
                                    <h6 class="card-subtitle">manage students here</h6>
                                    <div class="row text-center justify-content-md-center">
                                    </div>
                                </center>
                            </div>
                    ...
                    <div class="col-lg-4 col-xlg-3 col-md-5">
                        <div class="card">
                            <div class="card-block">
                                <center class="m-t-30">
                                    <a href="<?php echo base_url('index.php/Welcome/chatroom_admin')?>">
                                        <img src="<?php echo base_url('asset/images/chat.png') ?>" class="img-circle" width="150" />
                                    </a>
                                    <a href="<?php echo base_url('index.php/Welcome/chatroom_admin')?>"> <h4 class="card-title m-t-10">Chat</h4></a>
                    ...
                    <div class="col-lg-4 col-xlg-3 col-md-5">
                        <div class="card">
                            <div class="card-block">
                                <center class="m-t-30">
                                    <a href="<?php echo base_url('index.php/Welcome/activity_trail')?>">
                                        <img src="<?php echo base_url('asset/images/report.png') ?>" class="img-circle" width="150" />
                                    </a>
                                    <a href="<?php echo base_url('index.php/Welcome/activity_trail')?>">
                                        <h4 class="card-title m-t-10">Activity Trail</h4>
                                    </a>
                                    <h6 class="card-subtitle">check out activity trail of users</h6>
                                    <div class="row text-center justify-content-md-center">
                                    </div>
                                </center>
                            </div>
                    ...
                    <div class="col-lg-4 col-xlg-3 col-md-5">
                        <div class="card">
                            <div class="card-block">
                                <center class="m-t-30">
                                    <a href="<?php echo base_url('index.php/Welcome/admin_log')?>">
                                        <img src="<?php echo base_url('asset/images/report.png') ?>" class="img-circle" width="150" />
                                    </a>
                                    <a href="<?php echo base_url('index.php/Welcome/admin_log')?>">
                                        <h4 class="card-title m-t-10">Logs</h4>
                                    </a>
                                    <h6 class="card-subtitle">check out users logs</h6>
                                    <div class="row text-center justify-content-md-center">
                                    </div>
                                </center>
                            </div>
                    ...
                    <div class="col-lg-4 col-xlg-3 col-md-5">
                        <div class="card">
                            <div class="card-block">
                                <center class="m-t-30">
                                    <a href="<?php echo base_url('index.php/Welcome/admin_profile')?>">
