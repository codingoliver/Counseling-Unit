    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form class="form-horizontal form-material" method="post"
                  action=""
                  onsubmit="return changePassword('counselor_profile')">
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="card" >
                            <form enctype="multipart/form-data" class="form-horizontal form-material" method="post"
                                  action=" <?php echo base_url('index.php/Welcome/update_user_profile/counselor') ?>" onsubmit="return enterProfileGate()">
