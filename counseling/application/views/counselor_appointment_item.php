...
<div id="main-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="row page-titles">
                <div class="col-md-5 col-8 align-self-center">
                    <h4 class="text-themecolor">Waiting Appointments</h4>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div id="filterString" data-filter=<?php echo $filter_string; ?> >
                </div>
                                        ...
                                        foreach ($data2 as $val) {
                                            ...
                                            echo "
                                                 <tr>   
                                                    ...
                                                    <td>$val->time</td>
                                                    <td>
                                                    <button class='btn btn-primary' style='margin-right: 5px' data-a_id=\"$val->a_id\" 
                                                    data-status =\"$val->status\" value='accepted'
                                                    ...
                                                    data-date=\"$val->date\" data-time=\"$val->time\" data-student=\"$name\">
                                                        Reschedule</button>
                                                    <button class='btn btn-danger' style='margin-right: 5px' data-a_id=\"$val->a_id\" data-status =\"$val->status\"
                                                     value='canceled' 
                                                      data-date=\"$val->date\" data-time=\"$val->time\" data-student=\"$name\">
                                                        Cancel</button>
                                                    </td>
    ...
    <script>
            ...
            $.post('http://localhost/counseling/index.php/Welcome/update_appointment/'+ $st,
                ...
                function (data, status) {
                    ...
                    if (status === 'success') {
                        ...
                        filter_string = '_';
                        window.location = "http://localhost/counseling/index.php/Welcome/counselor_appointment_item/"+filter_string;
                    } else {
        ...
        $(function () {
            var filterString = $('#filterString').data('filter');
            var newFilterString = '';
            for (var i in filterString) {
                if(filterString[i] === '_') {
                    newFilterString += ' ';
                } else {
                    newFilterString += filterString[i];
                }
            }
            $('#myTable').DataTable().search(newFilterString).draw();
        });
